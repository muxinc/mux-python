...
class DeliveryReport(object):
    ...
    def __init__(self, live_stream_id=None, asset_id=None, passthrough=None, created_at=None, asset_state=None, asset_duration=None, delivered_seconds=None, local_vars_configuration=None):  # noqa: E501
