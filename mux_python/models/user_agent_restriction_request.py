...
class UserAgentRestrictionRequest(object):
    ...
    def __init__(self, allow_no_user_agent=True, allow_high_risk_user_agent=True, local_vars_configuration=None):  # noqa: E501
        """UserAgentRestrictionRequest - a model defined in OpenAPI"""  # noqa: E501
    ...
    def allow_no_user_agent(self):
        """Gets the allow_no_user_agent of this UserAgentRestrictionRequest.  # noqa: E501

        Whether or not to allow views without a `User-Agent` HTTP request header.  # noqa: E501

        :return: The allow_no_user_agent of this UserAgentRestrictionRequest.  # noqa: E501
        :rtype: bool
        """
    ...
    def allow_no_user_agent(self, allow_no_user_agent):
        """Sets the allow_no_user_agent of this UserAgentRestrictionRequest.

        Whether or not to allow views without a `User-Agent` HTTP request header.  # noqa: E501

        :param allow_no_user_agent: The allow_no_user_agent of this UserAgentRestrictionRequest.  # noqa: E501
    ...
    def allow_high_risk_user_agent(self):
        """Gets the allow_high_risk_user_agent of this UserAgentRestrictionRequest.  # noqa: E501

        Whether or not to allow high risk user agents. The high risk user agents are defined by Mux.  # noqa: E501

        :return: The allow_high_risk_user_agent of this UserAgentRestrictionRequest.  # noqa: E501
        :rtype: bool
        """
    ...
    def allow_high_risk_user_agent(self, allow_high_risk_user_agent):
        """Sets the allow_high_risk_user_agent of this UserAgentRestrictionRequest.

        Whether or not to allow high risk user agents. The high risk user agents are defined by Mux.  # noqa: E501

        :param allow_high_risk_user_agent: The allow_high_risk_user_agent of this UserAgentRestrictionRequest.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserAgentRestrictionRequest):
            return False
