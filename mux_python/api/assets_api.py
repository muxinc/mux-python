...
class AssetsApi(object):
    ...
    def generate_asset_track_subtitles(self, asset_id, track_id, generate_track_subtitles_request, **kwargs):  # noqa: E501
        """Generate track subtitles  # noqa: E501

        Generates subtitles (captions) for a given audio track. This API can be used for up to 7 days after an asset is created.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.generate_asset_track_subtitles(asset_id, track_id, generate_track_subtitles_request, async_req=True)
        >>> result = thread.get()
        ...
        :param track_id: The track ID. (required)
        :type track_id: str
        :param generate_track_subtitles_request: (required)
        :type generate_track_subtitles_request: GenerateTrackSubtitlesRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: GenerateTrackSubtitlesResponse
        """
        kwargs['_return_http_data_only'] = True
        return self.generate_asset_track_subtitles_with_http_info(asset_id, track_id, generate_track_subtitles_request, **kwargs)  # noqa: E501

    def generate_asset_track_subtitles_with_http_info(self, asset_id, track_id, generate_track_subtitles_request, **kwargs):  # noqa: E501
        """Generate track subtitles  # noqa: E501
        ...
        >>> thread = api.generate_asset_track_subtitles_with_http_info(asset_id, track_id, generate_track_subtitles_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GenerateTrackSubtitlesResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method generate_asset_track_subtitles" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'asset_id' is set
        if self.api_client.client_side_validation and ('asset_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['asset_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `asset_id` when calling `generate_asset_track_subtitles`")  # noqa: E501
        # verify the required parameter 'track_id' is set
        if self.api_client.client_side_validation and ('track_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['track_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `track_id` when calling `generate_asset_track_subtitles`")  # noqa: E501
        # verify the required parameter 'generate_track_subtitles_request' is set
        if self.api_client.client_side_validation and ('generate_track_subtitles_request' not in local_var_params or  # noqa: E501
                                                        local_var_params['generate_track_subtitles_request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `generate_track_subtitles_request` when calling `generate_asset_track_subtitles`")  # noqa: E501
        ...
        body_params = None
        if 'generate_track_subtitles_request' in local_var_params:
            body_params = local_var_params['generate_track_subtitles_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        response_types_map = {
            201: "GenerateTrackSubtitlesResponse",
        }

        return self.api_client.call_api(
            '/video/v1/assets/{ASSET_ID}/tracks/{TRACK_ID}/generate-subtitles', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
