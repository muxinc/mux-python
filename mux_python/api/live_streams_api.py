...
class LiveStreamsApi(object):
    ...
    def delete_live_stream_static_renditions(self, live_stream_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.delete_live_stream_static_renditions(live_stream_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.delete_live_stream_static_renditions_with_http_info(live_stream_id, **kwargs)  # noqa: E501

    def delete_live_stream_static_renditions_with_http_info(self, live_stream_id, **kwargs):  # noqa: E501
        """Delete a live stream's static renditions setting for new assets  # noqa: E501
        ...
        >>> thread = api.delete_live_stream_static_renditions_with_http_info(live_stream_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_live_stream_static_renditions" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'live_stream_id' is set
        if self.api_client.client_side_validation and ('live_stream_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['live_stream_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `live_stream_id` when calling `delete_live_stream_static_renditions`")  # noqa: E501
    ...
    def update_live_stream_static_renditions(self, live_stream_id, update_live_stream_new_asset_settings_static_renditions_request, **kwargs):  # noqa: E501
        ...
        >>> thread = api.update_live_stream_static_renditions(live_stream_id, update_live_stream_new_asset_settings_static_renditions_request, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_live_stream_static_renditions_with_http_info(live_stream_id, update_live_stream_new_asset_settings_static_renditions_request, **kwargs)  # noqa: E501

    def update_live_stream_static_renditions_with_http_info(self, live_stream_id, update_live_stream_new_asset_settings_static_renditions_request, **kwargs):  # noqa: E501
        """Update live stream static renditions for new assets  # noqa: E501
        ...
        >>> thread = api.update_live_stream_static_renditions_with_http_info(live_stream_id, update_live_stream_new_asset_settings_static_renditions_request, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_live_stream_static_renditions" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'live_stream_id' is set
        if self.api_client.client_side_validation and ('live_stream_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['live_stream_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `live_stream_id` when calling `update_live_stream_static_renditions`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('update_live_stream_new_asset_settings_static_renditions_request' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `update_live_stream_new_asset_settings_static_renditions_request` when calling `update_live_stream_static_renditions`")  # noqa: E501
